...
import SceneNineteen from '../components/ch2-scenes/sceneNineteen'
...
export default function debugUI10() {
    ...
    return (
        <>
            <Layout
                lessonName='19. Raycaster'
                lessonLink={'/19-raycaster'}
                lessonNum={10}
                chNum={1}
            >
                <CanvasLayout cameraPosition={new THREE.Vector3(0, 0, 4)}>
                    <SceneNineteen 
